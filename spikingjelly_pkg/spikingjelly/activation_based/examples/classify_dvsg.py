...
def main():
    ...
    net = spiking_resnet.spiking_resnet18(pretrained=False, spiking_neuron=neuron.ParametricLIFNode, surrogate_function=surrogate.ATan(), detach_reset=True)
    ...
    out_dir = os.path.join(args.out_dir, f'DVSGesture_ResAttention_PLIF_T{args.T}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}')
