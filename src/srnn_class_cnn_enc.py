...
def main():
    ...
    parser.add_argument('-model', default='srnn_cnn', type=str, help='use which model, "srnn_cnn", "srnn_crnn"')
    ...
    out_dir = os.path.join(args.out_dir, f'DVSHandObjectSRNN_CNN_IF_T{args.T}_b{args.b}_{args.opt}_lr{args.lr}_c{args.channels}')
    if args.amp:
        out_dir += '_amp'
